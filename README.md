...
### 2.2. Активировать акружение. 
Это необходимо делать каждый раз,
...
```
Называйте файл с зависимостями проекта (с пакетами) `requirements.txt`
...
механизм абстракций, называемый моделью. При проектировании 
приложения (сайта, программы и тд) в современной практике 
используют принцип ООП, согласно которому *модель сопоставляется с
...
### 4.3. Контекст 
Модификация view и шаблона для демонстрации людей и их 
контактов на сайте.
